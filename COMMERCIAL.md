...
Choose the commercial license if any of the following apply:
...
The Apache 2.0 license is sufficient for:

- Academic research and publication
- Non-competing commercial product development
- Internal corporate use (training models, testing systems, populating demos)
- Redistribution of synthetic output data (the synthetic data output is license-free regardless of which license governs the generator)
- Contributing clinical modules back to the community

## Pricing

Commercial licensing is offered in three tiers, negotiated based on deployment scale and support needs:

- **Research Tier** — for academic institutions and non-profit research organizations
- **Enterprise Tier** — for commercial organizations deploying Atlas internally
- **OEM Tier** — for organizations embedding Atlas in commercial products
